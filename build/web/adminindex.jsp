            ...
            try {
                ...
                if (request.getParameter("Action").equalsIgnoreCase("Send")) {
                    try {
                        ...
                        sql = "INSERT INTO `mydb`.`home` (`id` ,`event`,`date`,`venue`,`organizer`)VALUES (NULL , '" + event + "','" + date + "','" + venue + "','" + organizer + "')";
        ...
        <div id="container">
			...
			<ul>
                          <li><b><a  href="adminindex.jsp">HOME</a></b></li>
                            <li><b><a  href="adminpage/userdetails.jsp">USER DETAILS</a></b></li>
                            <li><b><a  href="adminlogout.jsp">LOGOUT</a></b></li>
                            <li><b><a  href="adminpage/adminreview.jsp">VIEW REVIEWS</a></b></li>
                    </ul>
                        </div>
            </div>
            <div id="content">
                <div id="bar">
                    ...
                    <ul>
                        <li>POST EVENTS:</li>
                        <li><a class ="selected" href="adminpage/adminsocial.jsp"> Social Events</a></li>
                        <li><a class ="selected" href="adminpage/admintech.jsp">Tech Events</a></li>
                        <li><a class ="selected" href="adminpage/adminedu.jsp">Educational Fairs</a></li>
                        <li><a class ="selected" href="adminpage/adminmusic.jsp">Music and Concerts</a></li>
                        <li>UPDATE EVENTS:</li>
                        <li><a class ="selected" href="adminpage/updatesocial.jsp"> Social Events</a></li>
                        <li><a class ="selected" href="adminpage/updatetech.jsp">Tech Events</a></li>
                        <li><a class ="selected" href="adminpage/updateedu.jsp">Educational Fairs</a></li>
                        <li><a class ="selected" href="adminpage/updatemusic.jsp">Music and Concerts</a></li>
                    </ul>
                      </div>
                </div>
                <div id="main">
				...
				<div id="main2">
                              <div id="content10">
                                        <form method ="post">
                        <textarea rows="4" cols="100" name="event" placeholder="Post latest events here of any field."></textarea><br>
