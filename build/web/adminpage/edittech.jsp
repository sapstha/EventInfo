...
<html>
    ...
    <body>
            ...
            try {
                ...
                if (request.getParameter("Action").equalsIgnoreCase("save")) {
                    try {
                        ...
                        sql = "insert into tech VALUES(null,'" + event + "','" + date + "','" + venue + "','" + organizer + "')";
                        //out.print(sql);
                    ...
                    try {
                        ...
                        sql = "update tech set event='" + event + "', date='" + date + "', venue='" + venue + "',organizer='" + organizer +"' where id='" + id + "'";
                        //out.print(sql);
                        int row = db.st.executeUpdate(sql);
                        out.print("<script>alert('Updated');window.location.assign('updatetech.jsp');</script>");
                    } catch (Exception e) {
                        out.print(e.getMessage());
                    }
                }
                    ...
                    try {
                     id = request.getParameter("id");
                        btnValue = "Update";
                       sql = "select * from tech where id='" + id + "'";
                       out.print(sql);
        ...
        <div id="container">
            ...
            <div id="contentevent">
                <div id="contentabc1">
                <h1>Update tech events</h1>
        <a href="updatetech.jsp">Back</a>
        <form method="get">
