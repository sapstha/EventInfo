...
if(request.getParameter("mode").equals("d")){
  int selectedId=Integer.parseInt(request.getParameter("stuid"));
...
<html>
    ...
    <body>
        ...
        <table border="1">
            <tr ><td colspan="4"><a href="adminadd.jsp">Update User</a></td></tr>
            <tr>
         <th>S.N</th>
            <th>name</th>
            <th>password</th>
    ...
    out.print("<tr><td>"+i+"</td><td>"+db.rs.getString(2)+"</td><td>"+db.rs.getString(3)+"</td><td>"+db.rs.getString(4)+"</td><td>"+db.rs.getString(5)+ 
            "</td><td> <a href='adminadd.jsp?Action=Edit&"
            + "id=" + db.rs.getString(1) + "'>Edit</a> | <a href='userdetails.jsp?mode=d&stuid=" + db.rs.getString(1) + "' onclick='return (confirm(\"Do you really want to delete ??\"))'>Delete</a></td></tr>");
    }
