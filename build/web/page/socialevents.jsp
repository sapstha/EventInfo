...
<html>
    ...
    <body>
        <div id="container">
            ...
            <div id="social">
                  <blockquote><b>SOCIAL EVENTS</b></blockquote>
                </div>
            <div id="content2">
                <p><q><i>The best place to find a helping hand is at the edge of your own arm</i></q></p>
                <blockquote><b>List of all social events according to their dates</b></blockquote>
               <table>
