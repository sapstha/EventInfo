    ...
    <body>
            ...
            try {
                ...
                if (request.getParameter("Action").equalsIgnoreCase("Send")) {
                    try {
                        ...
                        sql = "INSERT INTO `mydb`.`tech` (`id` ,`event`,`date`,`venue`,`organizer`)VALUES (NULL , '" + event + "','" + date + "','" + venue + "','" + organizer + "')";
                          out.print(sql);
        ...
        <div id="container">
            ...
            <div id="contentevent">
                <div id="contentabc">
                    <form method ="post">
                        <textarea rows="8" cols="100" name="event" placeholder="Post upcoming tech events of your organization"></textarea><br>
