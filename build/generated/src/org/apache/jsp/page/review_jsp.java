  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("         ");
            ...
            String email="", reviews="";
            try {

                if (request.getParameter("Action").equalsIgnoreCase("Send")) {
                    try {
                         email = request.getParameter("email");
                         reviews = request.getParameter("reviews");
                        sql = "insert into review VALUES(null,'" + email + "','" +reviews + "')";
                        out.print(sql);
      ...
      out.write("                  </tr>\r\n");
      out.write("                            <center><h3 class=\"selected1\" ><b>Reviews:</b></h3> </center>\r\n");
      out.write("                                    \r\n");
      out.write("                                   ");
    ...
    out.print("<tr><td>" + i + "</td><td>" + db.rs.getString(2) + "</td><td>" + db.rs.getString(3));
      ...
      out.write("</table>\r\n");
      out.write("                </div><br>\r\n");
      out.write("                     <div id=\"content3c\">\r\n");
      out.write("                         <form method =\"post\">\r\n");
      out.write("                             <blockquote><b>Place your reviews here.</b></blockquote>\r\n");
      out.write("                             <input type=\"text\" name=\"email\" size=50 placeholder=\"E-mail here\"><p>\r\n");
      out.write("                                      <textarea rows=\"4\" cols=\"100\" name=\"review\" placeholder=\"Write reviews.\"></textarea><p>\r\n");
      out.write("                             &nbsp;&nbsp;&nbsp;&nbsp;<input type=\"submit\" name=\"Action\" value=\"Post\">&nbsp;&nbsp;\r\n");
      out.write("                         </form>\r\n");
      out.write("            </div>\r\n");
      out.write("                </div>\r\n");
