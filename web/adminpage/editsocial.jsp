...
<html>
    ...
    <body>
            ...
            try {
                ...
                if (request.getParameter("Action").equalsIgnoreCase("save")) {
                    try {
                        ...
                        sql = "insert into social VALUES(null,'" + event + "','" + date + "','" + venue + "','" + organizer + "')";
                        //out.print(sql);
                    ...
                    try {
                        ...
                        venue = request.getParameter("venue");
                        organizer = request.getParameter("organizer");
                        sql = "update social set event='" + event + "', date='" + date + "', venue='" + venue + "',organizer='" + organizer +"' where id='" + id + "'";
                        //out.print(sql);
                        int row = db.st.executeUpdate(sql);
                    ...
                    organizer = db.rs.getString(5); 
                      out.print(id+event+date+venue+organizer);
        ...
        <div id="container">
            ...
            <div id="contentevent">
                <div id="contentabc1">
                    <h1>Update social events</h1>
        <a href="updatesocial.jsp">Back</a>
        <form method="get">
