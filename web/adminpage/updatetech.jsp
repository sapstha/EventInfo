...
if(request.getParameter("mode").equals("d")){
  ...
  String sql="delete from tech where id="+selectedId+"";
...
<html>
    ...
    <body>
        <div id="container">
            ...
            <div id="contentevent">
                <div id="contentabc1">
                    <center><h1>Tech Event Details</h1></center>
                    <table border="1">
                        <tr ><td colspan="4"><a href="edittech.jsp">Post Events Here</a></td></tr>
                        <tr>
                            <th>S.N</th>
                            ...
                            try {
                                ...
                                for (int i = 1; db.rs.next(); i++) {
                                    out.print("<tr><td>" + i + "</td><td>" + db.rs.getString(2) + "</td><td>" + db.rs.getString(3) + "</td><td>" + db.rs.getString(4) + "</td><td>" + db.rs.getString(5) + "</td>"
                                            + "</td><td> <a href='edittech.jsp?Action=Edit&"
                                            + "id=" + db.rs.getString(1) + "'>Edit</a> | <a href='updatetech.jsp?mode=d&id=" + db.rs.getString(1) + "' onclick='return (confirm(\"Do you really want to delete ??\"))'>Delete</a></td></tr>");
                                }
                            } catch (Exception e) {
                                out.print(e);
                            }
