            ...
            try {
                ...
                if (request.getParameter("Action").equalsIgnoreCase("Send")) {
                    try {
                        ...
                        sql = "INSERT INTO `mydb`.`edufair` (`id` ,`event`,`date`,`venue`,`organizer`)VALUES (NULL , '" + event + "','" + date + "','" + venue + "','" + organizer + "')";
                          out.print(sql);
        ...
        <div id="container">
            ...
            <div id="bar">
                <div id="bar_wrapper">
                    <ul>
                        <li>POST EVENTS:</li>
                        <li><a class ="selected" href="orgsocial.jsp"> Social Events</a></li>
                        <li><a class ="selected" href="orgtech.jsp">Tech Events</a></li>
                        <li><a class ="selected" href="orgedu.jsp">Educational Fairs</a></li>
                        <li><a class ="selected" href="orgmusic.jsp">Music and Concerts</a></li>
                    </ul>
                </div>
            </div>
            <div id="contentevent">
                <div id="contentabc">
                    <form method ="post">
                        <textarea rows="8" cols="100" name="event" placeholder="Post upcoming educational fairs of your organization"></textarea><br>
